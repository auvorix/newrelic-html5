import { actionWithDelay } from '@newrelic/rrweb-types';
import { addedNodeMutation } from '@newrelic/rrweb-types';
import { blockClass } from '@newrelic/rrweb-types';
import { canvasMutationData } from '@newrelic/rrweb-types';
import { DataURLOptions } from '@newrelic/rrweb-types';
import { DeprecatedMirror } from '@newrelic/rrweb-types';
import { DocumentDimension } from '@newrelic/rrweb-types';
import { Emitter } from '@newrelic/rrweb-types';
import { EventType } from '@newrelic/rrweb-types';
import { eventWithTime } from '@newrelic/rrweb-types';
import { Handler } from '@newrelic/rrweb-types';
import { hookResetter } from '@newrelic/rrweb-types';
import { hooksParam } from '@newrelic/rrweb-types';
import { IMirror } from '@newrelic/rrweb-types';
import { IncrementalSource } from '@newrelic/rrweb-types';
import { IWindow } from '@newrelic/rrweb-types';
import { KeepIframeSrcFn } from '@newrelic/rrweb-types';
import { listenerHandler } from '@newrelic/rrweb-types';
import { MaskInputFn } from '@newrelic/rrweb-snapshot';
import { MaskInputOptions } from '@newrelic/rrweb-snapshot';
import { maskTextClass } from '@newrelic/rrweb-types';
import { MaskTextFn } from '@newrelic/rrweb-snapshot';
import { Mirror } from '@newrelic/rrweb-snapshot';
import { MouseInteractions } from '@newrelic/rrweb-types';
import { PackFn } from '@newrelic/rrweb-types';
import { playerMetaData } from '@newrelic/rrweb-types';
import { RecordPlugin } from '@newrelic/rrweb-types';
import { ReplayerEvents } from '@newrelic/rrweb-types';
import { RRDocument } from '@newrelic/rrdom';
import { RRIFrameElement } from '@newrelic/rrdom';
import { RRNode } from '@newrelic/rrdom';
import { SamplingStrategy } from '@newrelic/rrweb-types';
import { SlimDOMOptions } from '@newrelic/rrweb-snapshot';
import { StateMachine } from '@xstate/fsm';
import { textMutation } from '@newrelic/rrweb-types';
import { throttleOptions } from '@newrelic/rrweb-types';
import { UnpackFn } from '@newrelic/rrweb-types';
