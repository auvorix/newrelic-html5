...
function getUntaintedPrototype$1(key) {
  ...
  const defaultObj = isWebKit$1() && angularZoneUnpatchedAlternative$1(key) || globalThis[key];
  ...
  untaintedBasePrototype$1[key] = impl;
  return impl;
}
...
function getUntaintedPrototype(key) {
  ...
  const defaultObj = isWebKit() && angularZoneUnpatchedAlternative(key) || globalThis[key];
  const defaultPrototype = defaultObj.prototype;
