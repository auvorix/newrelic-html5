import { canvasEventWithTime } from '@newrelic/rrweb-types';
import { canvasMutationData } from '@newrelic/rrweb-types';
import { IMirror } from '@newrelic/rrweb-types';
import { inputData } from '@newrelic/rrweb-types';
import { Mirror as Mirror_2 } from '@newrelic/rrweb-snapshot';
import { NodeType as NodeType_2 } from '@newrelic/rrweb-types';
import { scrollData } from '@newrelic/rrweb-types';
import { serializedNodeWithId } from '@newrelic/rrweb-types';
import { styleDeclarationData } from '@newrelic/rrweb-types';
import { styleSheetRuleData } from '@newrelic/rrweb-types';
